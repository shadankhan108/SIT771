...
public class TransferTransaction
{
    ...
    public void Execute()
    {
        if (_executed)
        {
            throw new Exception("Cannot execute transaction it has already been executed.");
        }
    ...
    public void Rollback()
    {
        if (!_executed)
        {
            throw new Exception("Cannot rollback transaction that has not been executed.");
        }
        if (_reversed)
        {
            throw new Exception("Cannot rollback transaction that has been reversed.");
        }
        if (_theWithdraw.Success)
        {
            _theWithdraw.Rollback();
    ...
    public void Print()
    {
        ...
        Console.WriteLine("    " + _theWithdraw);
        Console.WriteLine("Deposit Transaction:");
        Console.WriteLine("    " + _theDeposit);
